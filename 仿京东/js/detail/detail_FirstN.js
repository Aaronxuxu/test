...
//获取MAP中元素属性
function adjust() {
    var map = document.getElementById("detail_FirstN");
...
function adjustPosition(position) {
    var pageWidth = document.getElementById('picNavBig').clientWidth; //获取页面宽度
    var pageHeith = document.getElementById('picNavBig').clientHeight; //获取页面高度

    var imageWidth = 3840; //图片的长宽
    var imageHeigth = 220;
